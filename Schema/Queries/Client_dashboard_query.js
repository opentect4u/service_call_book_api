...
const { ClientGetTktDashboard, ClientMonthlySupport, ClientOpenCloseTkt, ClientLastTkt, ClientClosedTkt } = require("../Modules/client_dashboard_model");
...
const client_closed_tkt = {
    type: new GraphQLList(SupportLogTypDf),
    args: {
        client_id: { type: GraphQLString }
    },
    async resolve(parent, args) {
        var result = await ClientClosedTkt(args);
        return result;
    }
}

module.exports = { client_get_tkt_dashboard, client_monthly_support, client_open_close_tkt, client_last_tkt, client_closed_tkt };